...
from chat.models import Register
...
def All_doctors(doctor_users):
    try:
        doctor_users = Register.objects.filter(role2='doctor')
        return doctor_users
    except Exception, e:
        doctor_users = Register.objects.get(role2='doctor')
        return doctor_users
